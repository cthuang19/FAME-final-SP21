...
public class GameEngine extends Application {
    ...
    public static final Font FONT_XLARGE = Font.font("optima", FontWeight.LIGHT, FontPosture.REGULAR, 35);
    public static final Font FONT_LARGE = Font.font("optima", FontWeight.LIGHT, FontPosture.REGULAR, 27);
    public static final Font FONT_SMALL = Font.font("optima", FontWeight.LIGHT, FontPosture.REGULAR, 15);
    public static final Font FONT_TITLE = Font.font("optima", FontWeight.LIGHT, FontPosture.REGULAR, 100);

    public static final Image BACKGROUND_IMAGE = new Image(".//Images/Background-4.png");

    /* the page of the current scene */
    enum Page {
        LANGUAGE, CREDITS, INITIAL, MAIN, GAME, PUZZLE, ENDLEVEL
    };
    ...
    /**
     * create the language scene and return it the scene contains languages buttons
     * and credits button
     * 
    ...
    private Scene getLanguageScene() {
        ...
        // draw game name
        Image game_name_image = new Image(".//Images/gui/blue/panel-5.png", BUTTON_WIDTH * 2, BUTTON_HEIGHT * 2, false,
                true);
        gc_language.drawImage(game_name_image, 130, 50);
        gc_language.setFill(Color.LIGHTYELLOW);
        gc_language.setFont(FONT_TITLE);
        gc_language.fillText("SPACE ODDITY", 350, 230);
        ...
        Image english_button_image = new Image(".//Images/gui/purple/panel-4.png", BUTTON_WIDTH, BUTTON_HEIGHT, false,
                true);
        gc_language.drawImage(english_button_image, 450, 400);
        english_button.setStyle(
                "-fx-background-color: transparent;-fx-border-color: transparent;-fx-text-fill: white;-fx-font-size: 25; -fx-font-family: optima");
        ...
        Image french_button_image = new Image(".//Images/gui/blue/panel-5.png", BUTTON_WIDTH, BUTTON_HEIGHT, false,
                true);
        gc_language.drawImage(french_button_image, 450, 600);
        french_button.setStyle(
                "-fx-background-color: transparent;-fx-border-color: transparent;-fx-text-fill: white;-fx-font-size: 25; -fx-font-family: optima;");
        ...
        Button credits_button = drawButton("Credits", gc_language, SMALL_BUTTON_X, SMALL_BUTTON_Y, SMALL_BUTTON_SIZE,
                SMALL_BUTTON_SIZE, Page.CREDITS);
        Button exit_button = drawButton("Exit ", gc_language, 25, SMALL_BUTTON_Y, SMALL_BUTTON_SIZE, SMALL_BUTTON_SIZE,
                null);
    ...
    /**
     * create the credits scene and return it the scene contains credits and back
     * button
     * 
     * @return the scene
     */
    private Scene getCreditsScene() {
        ...
        Button back_button = drawButton("Back", gc_credits, SMALL_BUTTON_X, SMALL_BUTTON_Y, SMALL_BUTTON_SIZE,
                SMALL_BUTTON_SIZE, Page.LANGUAGE);
    ...
    /**
     * create the initial scene according to the language chosen and return it the
     * scene contains story and next and back buttons
     * 
    ...
    private Scene getInitialScene() {
        ...
        Button next_button = drawButton("Next", gc_initial, SMALL_BUTTON_X, SMALL_BUTTON_Y, SMALL_BUTTON_SIZE,
                SMALL_BUTTON_SIZE, Page.MAIN);
        Button back_button = drawButton("Back", gc_initial, 25, SMALL_BUTTON_Y, SMALL_BUTTON_SIZE, SMALL_BUTTON_SIZE,
                Page.LANGUAGE);
    ...
    /**
     * create the main scene and return it the scene contains level buttons
     * 
    ...
    public Scene getMainScene() {
        ...
        for (int i = 0; i < max_unlocked_level; i++) {
            ...
            if (i < 3) {
                gc_main.drawImage(button_images.get(i), 250 + 400 * i, 70);
                level_buttons.get(i).setLayoutX(250 + 400 * i);
                level_buttons.get(i).setLayoutY(70);
            } else {
                gc_main.drawImage(button_images.get(i), 1050 - 400 * (i - 3), 370);
                level_buttons.get(i).setLayoutX(1050 - 400 * (i - 3));
                level_buttons.get(i).setLayoutY(370);
            }

            level_buttons.get(i).setStyle(
                    "-fx-background-color: transparent;-fx-border-color: transparent;-fx-text-fill: white;-fx-font-size: 28; -fx-font-family: optima;");
        ...
        /*
         * AnimatedImage ship = new AnimatedImage(); final Image[] fship = new Image[4];
         * for (int i=0;i<4;i++) fship[i] = new
         * Image(".//Images/spaceship/red_ship/red_ship_"+i+".png");
         * ship.setFrames(fship); ship.setDuration(0.2);
        ...
        Button back_button = drawButton("Back", gc_main, 25, SMALL_BUTTON_Y, SMALL_BUTTON_SIZE, SMALL_BUTTON_SIZE,
                Page.INITIAL);
        Button commands_button = drawButton("Cmds", gc_main, SMALL_BUTTON_X, SMALL_BUTTON_Y, SMALL_BUTTON_SIZE,
                SMALL_BUTTON_SIZE, null);
        ...
        commands_button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                if (!isCmd) {
                    ...
                    gc_main.drawImage(BACKGROUND_IMAGE, 130, 580, 1190, 220, 130, 580, 1190, 220);
                    isCmd = false;
                }
    ...
    /**
     * create the game scene and return it the scene contains the level
     * 
    ...
    public Scene getGameScene() {
        ...
        scene_game.setOnKeyReleased(new EventHandler<KeyEvent>() {
            public void handle(KeyEvent e) {
                String code = e.getCode().toString();
                input.remove(code);
            }
        ...
        new AnimationTimer() {
            public void handle(long current_nano_time) {
                ...
                if (offsetX < 0)
                    offsetX = 0;
                if (offsetX > main_game.getDimensionX() - CANVAS_WIDTH)
                    offsetX = main_game.getDimensionX() - CANVAS_WIDTH;

                double offsetY = display_player.getPositionY() - CANVAS_HEIGHT / 2;
                if (offsetY < 0)
                    offsetY = 0;
                if (offsetY > main_game.getDimensionY() - CANVAS_HEIGHT)
                    offsetY = main_game.getDimensionY() - CANVAS_HEIGHT;
                ...
                for (Door d : display_door) {
                    gc_game.drawImage(d.getFrame(0), d.getPositionX() - offsetX, d.getPositionY() - offsetY,
                            MAIN_GAME_DISPLAY_WIDTH, MAIN_GAME_DISPLAY_WIDTH);
                }

                // draw the player
                gc_game.drawImage(display_player.getFrame(t), display_player.getPositionX() - offsetX,
                        display_player.getPositionY() - offsetY);
    ...
    /**
     * create the puzzle scene and return it the scene contains the puzzle
     * 
    ...
    public Scene getPuzzleScene() {
        ...
        // deal with the key events
        scene_puzzle.setOnKeyPressed(new EventHandler<KeyEvent>() {
            public void handle(KeyEvent e) {
        ...
        scene_puzzle.setOnKeyReleased(new EventHandler<KeyEvent>() {
            public void handle(KeyEvent e) {
                String code = e.getCode().toString();
                input.remove(code);
            }
        ...
        new AnimationTimer() {
            public void handle(long current_nano_time) {
                ...
                // draw the player
                gc_puzzle.drawImage(display_player.getFrame(t), display_player.getPositionX(),
    ...
    /**
     * create the end of level scene and return it the scene contains a message and
    ...
    /**
     * draw the important information for the game at the top of the screen level,
     * lives, field energy
     * 
    ...
    public void drawPlayerStatus(GraphicsContext gc, double player_lives, double player_field_energy,
            String type_of_game) {
     ...
     */
    private Button drawButton(String message, GraphicsContext gc, int x, int y, int button_w, int button_h,
            Page destination) {
        ...
        if (message.equals("Restart") || message.equals("Exit") || message.equals("Choose another level")) {
            ...
            button.setStyle(
                    "-fx-background-color: transparent;-fx-border-color: transparent;-fx-text-fill: white;-fx-font-size: 20; -fx-font-family: optima");
